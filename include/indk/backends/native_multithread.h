/////////////////////////////////////////////////////////////////////////////
// Name:        indk/backends/native_multithred.h
// Purpose:     Native CPU with multithreading support compute backend class header
...
namespace indk {
    namespace ComputeBackends {
        ...
        public:
            ...
            void doCompute(const std::vector<indk::Neuron*> &neurons, const std::vector<std::vector<float>> &x, const std::vector<std::string>& inputs, void *_model) override;
